...
import { fetchPlayersDetails } from "@/app/lib/actions";
    ...
    const renderTableRows = (playerType: string) => {
        ...
        return filteredPlayers.map((player) => {
            ...
            return (
                ...
                >
                    <td className="whitespace-nowrap px-4 py-3">{player.player_name}</td>
                    <td className="whitespace-nowrap px-3 py-3 capitalize">{player.role}</td>
                    <td className="whitespace-nowrap px-3 py-3 flex flex-row items-center justify-center">
                        <span
